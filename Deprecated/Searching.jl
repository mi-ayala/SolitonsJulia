...
# ╔═╡ b09f850e-6b99-11ed-0d88-050b9a969b73
begin
...
# ╔═╡ 74753013-5cbc-4bdb-9640-296b5fd5dd43
begin
...
# ╔═╡ 7618c90f-3d6d-435d-bd2f-f2c43194a100
begin
	file = jldopen("Manifold.jld2");
	P = file["P"];
end

# ╔═╡ 3e971169-0e4d-41b3-b5fe-69f19e4e6a52
begin
	N = 1000
...
# ╔═╡ ea79eaa5-3023-446e-b50d-92aefd1b2cd3
begin
	p1 = zeros(N)
...
# ╔═╡ 91306b77-35c1-4342-bae6-1de57b73871a
begin
	using Plots
...
# ╔═╡ 00e1dddd-065e-4e7f-b4d5-e021e0063c59
# begin
# 	  #### Testing shooting
...
# ╔═╡ f5555ce1-649c-41c7-96e5-903c0b1906c7
begin


		function search(σ, L, parameters)
...
# ╔═╡ 8f43153d-4ca7-4f7b-8fdf-bb4a3745e6d8

	
	 search(.5, 1, parameters)
...
julia_version = "1.8.3"
manifest_format = "2.0"
project_hash = "5f1eeb1e79df368a1ac289f711bac43c048a95a6"
...
git-tree-sha1 = "91873a995d1eb81cf0fa40760953a613c89dad05"
...
git-tree-sha1 = "fe3a2f732c1c144d52d57e2f9951302c7f6415a8"
