...
function F!(F, P, para, N_F, N_T,v)
    ...
    function DF!(DF, P, para, N_F, N_T)
        ...
        project!(component(DF, 2, 2), component(Df, 2,2) + Derivative(1,0) + λ*project(Derivative(0,1), domain(component(Df, 2, 2)), domain(component(Df,1,1)), ComplexF64))
        ...
        project!(component(DF, 3, 3), component(Df, 3,3) + Derivative(1,0) + λ*project(Derivative(0,1), domain(component(Df, 3, 3)), domain(component(Df,1,1)), ComplexF64))
        ...
        project!(component(DF, 4, 4), component(Df, 4,4) + Derivative(1,0) + λ*project(Derivative(0,1), domain(component(Df, 4, 4)), domain(component(Df,1,1)), ComplexF64))
